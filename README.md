...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/sbir_search_awards \
  -H 'Content-Type: application/json' \
  -d '{"keyword":"machine learning","agency":"DOW","year":2024,"limit":20}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/sbir_search_awards`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
